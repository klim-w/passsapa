...
const fullJs = `
${jsCode}
module.exports = { SAMPLE_SUBJECTS, SAMPLE_QUESTIONS, SAMPLE_STUDY_MATERIALS, SAMPLE_KNOWLEDGE_ARTICLES };
`;
...
const { SAMPLE_SUBJECTS, SAMPLE_QUESTIONS, SAMPLE_STUDY_MATERIALS, SAMPLE_KNOWLEDGE_ARTICLES } = context.module.exports;
