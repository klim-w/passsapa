...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigate, onOpenPayment }) => {
  ...
  return (
    <div className="space-y-6 py-4 max-w-6xl mx-auto">
      ...
      <div className="flex flex-wrap gap-1.5 bg-emerald-900/10 dark:bg-white/[0.02] p-1.5 rounded-full sticky top-16 z-40 backdrop-blur-md">
        <button
          onClick={() => setActiveTab("overview")}
          className={`px-4 py-1.5 rounded-full text-xs font-heading transition-all ${
            activeTab === "overview" ? "bg-emerald-800/15 dark:bg-emerald-500/15 text-emerald-900 dark:text-emerald-400 font-bold" : "text-slate-800 dark:text-gray-400 hover:text-emerald-900"
          }`}
        >
          📌 ภาพรวม (Overview)
        </button>
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-xs font-heading transition-all ${
            activeTab === "subjects" ? "bg-emerald-800/15 dark:bg-emerald-500/15 text-emerald-900 dark:text-emerald-400 font-bold" : "text-slate-800 dark:text-gray-400 hover:text-emerald-900"
          }`}
        >
          🌿 5 สาขาวิชา
        </button>
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-xs font-heading transition-all ${
            activeTab === "quiz" ? "bg-emerald-800/15 dark:bg-emerald-500/15 text-emerald-900 dark:text-emerald-400 font-bold" : "text-slate-800 dark:text-gray-400 hover:text-emerald-900"
          }`}
        >
          🧪 ทดลองทำข้อสอบ
        </button>
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-xs font-heading transition-all ${
            activeTab === "news" ? "bg-emerald-800/15 dark:bg-emerald-500/15 text-emerald-900 dark:text-emerald-400 font-bold" : "text-slate-800 dark:text-gray-400 hover:text-emerald-900"
          }`}
        >
          📢 ข่าวสารสภาฯ
        </button>
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-xs font-heading transition-all ${
            activeTab === "pricing" ? "bg-amber-700/15 dark:bg-amber-500/15 text-amber-900 dark:text-amber-300 font-bold" : "text-slate-800 dark:text-gray-400 hover:text-emerald-900"
          }`}
        >
          💳 ราคาแพ็กเกจ
        </button>
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-xs font-heading transition-all ${
            activeTab === "faq" ? "bg-emerald-800/15 dark:bg-emerald-500/15 text-emerald-900 dark:text-emerald-400 font-bold" : "text-slate-800 dark:text-gray-400 hover:text-emerald-900"
          }`}
        >
          ❓ คำถามพบบ่อย
        </button>
          ...
          <section className="glass-panel-emerald p-6 md:p-10 space-y-4 rounded-3xl">
            <div className="max-w-2xl space-y-4">
              ...
              <div className="flex flex-wrap gap-3 pt-1">
                ...
                <button onClick={() => setActiveTab("pricing")} className="px-6 py-2.5 rounded-full bg-emerald-900/10 dark:bg-white/5 text-slate-900 dark:text-white font-heading text-sm hover:bg-emerald-900/20 dark:hover:bg-white/10 transition-all font-semibold border border-emerald-900/15 dark:border-white/10">
                  💎 ดูแพ็กเกจราคา
                </button>
              </div>
            </div>
